...
if \tcode{D} is unnamed enumeration,
...
\item Each such definition of \tcode{D} shall consist of
...
\item In each such definition of \tcode{D}, corresponding names, looked up
...
\item In each such definition of \tcode{D}, except within
...
\item In each such definition of \tcode{D}, corresponding entities shall have the
same language linkage.

\item In each such definition of \tcode{D}, the overloaded operators referred
...
\item In each such definition of \tcode{D},
