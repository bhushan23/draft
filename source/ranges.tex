...
\item
  ...
  \tcode{enable_safe_range<remove_cv_t<T>>} is \tcode{false},
...
\item
  Otherwise, if
  \tcode{\placeholdernc{make-unsigned-like}(ranges::end(t) - ranges::begin(t))}\iref{ranges.syn}
  ...
  \tcode{\placeholdernc{make-unsigned-like}(ranges::end(t) - ranges::begin(t))}.
