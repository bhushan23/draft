...
before its \grammarterm{private-module-fragment} (if any).
...
a non-TU-local entity
in a module interface unit (outside the private-module-fragment, if any) or
