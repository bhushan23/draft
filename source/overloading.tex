...
class Y {
  ...
  void i() &;
  void i() const;               // error: prior declaration of \tcode{i} has a ref-qualifier
};
\end{codeblock}
\end{example}
...
void h(int (*x)()) { }          // error: redefinition of \tcode{h(int())}
\end{codeblock}
\end{example}
...
$T_i$ is an rvalue reference to the declared type of $e_i$, and
\item
