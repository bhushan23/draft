...
they are both declared with \grammarterm{type-constraint}s that are equivalent,
...
\begin{itemize}
\item
If, for either template, some of the \grammarterm{template-parameter}{s}
...
such that the corresponding \grammarterm{template-parameter}{s}
of the \grammarterm{template-parameter-list}{s} are equivalent and
such that the function parameters that positionally correspond
